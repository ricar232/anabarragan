    ...
    <div class="container">
        ...
        <form action="" method="POST" class="form">
            ...
            <div class="form-group">
                ...
                <input type="text" id="medicare" name="medicare" value="<?php echo htmlspecialchars($usuario['medicare']); ?>" required>
            </div>
            <div class="form-group">
                <label for="medicaid"><i class="fas fa-clinic-medical"></i> Medicaid:</label>
                <input type="text" id="medicaid" name="medicaid" value="<?php echo htmlspecialchars($usuario['medicaid']); ?>" required>
            </div>
            <div class="form-group">
                <label for="dr_primario"><i class="fas fa-user-md"></i> Nombre del Dr. Primario:</label>
                <input type="text" id="dr_primario" name="dr_primario" value="<?php echo htmlspecialchars($usuario['dr_primario']); ?>" required>
            </div>
            <div class="form-group">
                <label for="id_pcp"><i class="fas fa-id-badge"></i> ID PCP:</label>
                <input type="text" id="id_pcp" name="id_pcp" value="<?php echo htmlspecialchars($usuario['id_pcp']); ?>" required>
            </div>
            <div class="form-group">
                <label for="npi"><i class="fas fa-fingerprint"></i> NPI:</label>
                <input type="text" id="npi" name="npi" value="<?php echo htmlspecialchars($usuario['npi']); ?>" required>
            </div>
            <div class="form-group">
                <label for="plan_medico"><i class="fas fa-file-medical-alt"></i> Plan Médico:</label>
                <input type="text" id="plan_medico" name="plan_medico" value="<?php echo htmlspecialchars($usuario['plan_medico']); ?>" required>
            </div>
